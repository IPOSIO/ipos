...
发行了10亿代币，在eos上。2亿空投，3亿给贡献者。5亿保留(或者给贡献者)。

发币给贡献者做法：任何对IPOS生态有贡献者都应该获得对应的币。例如提出bug，提供代码，提供文档等。

IPOS 没有中心化开发团队，没有中心化运营团队。
任何人都可以给IPOS提供代码，被merge 的作者会得到相应的IPOS奖励。（issue方式奖励，即有人为IPOS做了贡献，则增加流通的IPOS币数量）

发行规则：有对IPOS做了贡献付出了劳动，IPOS生态则issue 对应数量的币 给贡献者。
